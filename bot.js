...
bot.command('start', (ctx) => {
  if (!ctx.session.apiKey) {
    ctx.reply(
      '*Welcome to Nous AI Bot*\n\n' +
      'To get started, send your Nous API Key:\n' +
      '1. Visit [Nous Website](https://portal.nousresearch.com/api-keys) and Log In\n' +
      '2. Go to the *API Keys_* section\n' +
      '3. Copy your API Key\n' +
      '4. Paste it here\n\n' +
      '🛡️ *Security Notice:*\n' +
